...
// del primer elemento.
// Pre: La lista fue creada.
// Post: Si se pudo agregar  el nuevo dato al inicio de la lista devuelve true, sino false.
bool lista_insertar_primero(lista_t *lista, void *dato);

// Se agrega el dato al final de la lista y devuelve true o false
// Pre: La lista fue creada 
// Post: Si se pudo agregar un elemento al final de la lista devuelve true, sino false.
...
// Si no estaba al final, el iteradr avanzo una posicion.
// Pre: La lista fue creada.
// Post: Devuelve true si el iterador esta al final, sino devuelve false. 
...
// Recibe un dato y  se inserta el valor entre la posicion anterior y el actual  del iterador.
// Pre: La lista y el iterador fueron creados.
// Post: Se devuelve true si se pudo insertar, en caso contrario false
bool lista_iter_insertar(lista_iter_t *iter, void *dato);

// Borrra el elemento actual del iterador. Si esta vacia o el iterador esta al final devuelve NULL.
...
// Post : La funcion visitar se aplica para cada elemento de la lista y si se puede devolver algun dato con el puntero extra.
